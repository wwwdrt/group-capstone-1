...
# 📖 [TasteBit] <a name="about-project"></a>

**[TasteBit]** This is a capstone project that displays a list of chicken dishes on a website.
...
- **[ The website is rendered using webpack ]**
- **[The webpage is also renreded dynamically using javascript]**
- **[The users can "like" any chicken dish and the total number of likes is displayed]**
- **[The chicken dishes are obtained from FREE MEAL API]**
- **[The likes are rendered using involvment API]**
- **[Users can add comments to a dish. This brings up a pop up window with a scroller for convenience]**
...
https://www.loom.com/share/f06137e1833a48a4ace39fd395abc507

## 🚀 Live Demo <a name="live-demo"></a>

- [Live Demo Link](https://wwwdrt.github.io/group-capstone-1/dist)
...
Clone this repository to your desired folder. Use the command: git clone https://github.com/wwwdrt/group-capstone-1.git
...
- [ ] **[Users should be able to also mqke reservations]**
- [ ] **[The reservation should also use involvement API]**
...
I would like to thank my coding partner Juan.
